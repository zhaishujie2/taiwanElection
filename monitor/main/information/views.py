...
def get_forum_statistics():
    ...
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "start_time or end_time is error"}), 406
        result = get_information_forum_statistics_count(start_time, end_time, dict_name)
        if result == 0:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
...
@mod.route('/get_all_statistics/', methods=['POST'])
def get_all_statistics():
    ...
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "start_time or end_time is error"}), 406
        result = get_information_all_statistics_count(start_time, end_time, dict_name)
        if result == 0:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
...
def get_forum_count():
    ...
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "start_time or end_time is error"}), 406
        result = get_forum_pages(name, start_time, end_time)
        if result == None:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
...
@mod.route('/forum_data/', methods=['POST'])
def forum_data():
    data = request.form.get('data', '')
    page_number = 0
    page_size = 0
    ...
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "input is error"}), 406
        result = get_forum_data(name, page_number, page_size, start_time, end_time)
        if result == None:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
...
@mod.route('/forum_all_pages/', methods=['POST'])
def get_all_forum_count():
    data = request.form.get('data', '')
    start_time = ""
    end_time = ""
    dict_name = {}
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "start_time or end_time is error"}), 406
        result = get_all_forum_pages(dict_name, start_time, end_time, )
        if result == None:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
...
@mod.route('/forum_all_data/', methods=['POST'])
def forum_data_all():
    data = request.form.get('data', '')
    page_number = 0
    page_size = 0
    ...
    if data == '':
        ...
        try:
            ...
            return jsonify({"message": "input is error"}), 406
        result = get_all_forum_data(dict_name, page_number, page_size, start_time, end_time)
        if result == None:
            return jsonify({"message": "The time field is in the wrong format"}), 200
        else:
            return jsonify({"message": result}), 200
