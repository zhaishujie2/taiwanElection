...
from monitor.main.system.operate_info import insert_info, delete_info, update_info, select_info, get_is_candidate, \
    ...
    select_partisan, get_image_infos, del_arr_image, change_arr_image, new_arr_image,login, add_new_user, \
    delete_user_info, update_users_info, select_users_all, select_user_info_one, select_user_info_page
import json, os
