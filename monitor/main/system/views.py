...
from monitor.main.system.operate_info import insert_info,delete_info,update_info,select_info,get_is_candidate,get_region_dict,get_one_infos,select_candidate_facebook,add_administrative_infos,insert_candidate_facebook,delete_people_information,update_people_information,get_everyinformation,get_all_years,insert_img,get_pages,allowed_file, \
...
def upload_file():
    try:
        ...
        if file and allowed_file(file.filename):
            ...
            file_url = url_for('system.uploaded_file', filename=file.filename)
