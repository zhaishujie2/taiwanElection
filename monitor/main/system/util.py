...
def get_time(start_time, end_time):
    try:
        ...
        end_time = int(
            time.mktime(datetime.datetime(end_time.year, end_time.month, end_time.day, 23, 59, 59).timetuple()))
        start_time = int(time.mktime(datetime.datetime(start_time.year, start_time.month, start_time.day, 0, 0,
                                                       0).timetuple()))  # start_time = time.mktime(datetime.datetime(start_day.year, start_day.month, start_day.day, 0, 0, 0))#
...
def get_date_item(date_time):
    return datetime.datetime.strptime(date_time,'%Y-%m').strftime('%Y-%m')
